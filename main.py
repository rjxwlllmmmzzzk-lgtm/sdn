...
# ===================== جميع الكلمات القوية (محفوظة بالكامل) =====================
VERBS_POWER = [
...
async def send_takleesh_messages(user_id, target, count, chat_id):
    ...
    for i in range(count):
        ...
        try:
            ...
            await bot.send_message(chat_id, f"✅ [{i+1}/{count}] تم الإرسال")
        except Exception as e:
...
async def send_tasteer_messages(user_id, target, lines, delay, chat_id):
    ...
    for i in range(lines):
        ...
        try:
            await client.send_message(target, word)
            await bot.send_message(chat_id, f"✅ [{i+1}/{lines}] تم الإرسال")
        except Exception as e:
            await bot.send_message(chat_id, f"❌ فشل: {str(e)}")
            break
...
# ==================================================
# =============== القسم الرابع: الأفعال الإضافية القوية ===============
# ==================================================
...
# ==================================================
# =============== القسم الخامس: الكلمات السعودية القوية ===============
# ==================================================
...
# ==================================================
# =============== القسم السادس: كلمات إضافية قوية جداً ===============
# ==================================================
...
# ==================================================
# =============== القسم السابع: كلمات التسطير القوية ===============
# ==================================================
...
# ==================================================
# =============== القسم الثامن: كلمات إضافية متنوعة ===============
# ==================================================
